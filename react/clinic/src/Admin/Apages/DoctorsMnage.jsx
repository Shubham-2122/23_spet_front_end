                            ...
                            <form method="post" className="php-email-form">
                                <div className="row gy-4">
                                    <div className="col-12">
                                        <input type="text" value={edited.name} onChange={getchange} name="name" className="form-control" placeholder="Doctors name" required />
                                    </div>
                                    <div className="col-12">
                                        <select name="type" value={edited.type} onChange={getchange} className="form-select" required>
                                    ...
                                    <div className="col-12">
                                        <input type="url" name="url" onChange={getchange} value={edited.url} className="form-control" placeholder="Full image" required />
                                    </div>
                                    ...
                                    <div className="col-12">
                                        <button type="submit" onClick={updatedata} className="btn btn-success">Update</button>
                                        <button type="submit" onClick={() => setedit(null)} className="btn btn-info mx-1">cancle</button>
                                    </div>
                                </div>
                            </form>
                        </div>
